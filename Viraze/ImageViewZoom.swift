...
open class ImageViewZoom: UIScrollView {
    ...
    private func setMaxMinZoomScalesForCurrentBounds() {
        ...
        minimumZoomScale = minScale * 0.999 // the multiply factor is to prevent user from scrolling page while they use this control in UIPageViewController
    }
    
    // MARK: - Gesture
    
    @objc func doubleTapGestureRecognizer(_ gestureRecognizer: UITapGestureRecognizer) {
...
//            let zoomRect = zoomRectForScale(maximumZoomScale / 3.0, center: gestureRecognizer.location(in: gestureRecognizer.view))
//            zoom(to: zoomRect, animated: true)
//        }
    }
