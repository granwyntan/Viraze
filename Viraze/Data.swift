...
let virusmore = [
    ...
    thing(question: "What should we do midst the COVID 19 situation?", answer: " - Wear masks\n - Social distance from others\n - Donate to hospitals\n - Maintain hygiene\n - Stay positive\n - Appreciate frontline workers\n - Do not stockpile food\n - Scan QR code at places sop that COVID 19 patients can be tracked easier")
]
