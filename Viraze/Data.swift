    ...
    VirusTable(
        ...
        data: [
            ...
            VirusTableItem(
                ...
                headerContents: VirusTableItemContent(
                    description: "You can make adjustments to the reusable masks distributed by the Government to fit your child, or make your own mask out of fabric or other similar materials, with the purpose of covering your child’s nose and mouth to reduce transmission of droplets.\n\nChildren 12 years and below may also use face shields in place of masks if they have difficulty wearing and keeping face masks on for a prolonged period of time.",
            ...
            VirusTableItem(
                ...
                headerContents: VirusTableItemContent(
                    description: "To protect your child and others, it is recommended that he wears a mask when leaving the house. If there is difficulty wearing and keeping face masks on for a prolonged period of time, children 12 years and below may use face shields in place of masks.\n\nMedical experts have advised that some groups may have difficulties wearing a mask, including children with special needs and young children aged two and above, and we will exercise flexibility in enforcement for these groups.",
        ...
        data: [
            ...
            VirusTableItem(
                ...
                headerContents: VirusTableItemContent(
                    ...
                    videoLink: "https://www.youtube.com/embed/nOa8wIhQdzo"
                )
            )
        ],
        sources: [
...
let virusmore = [
    ...
    thing(question: "Can COVID-19 spread through blood transfusion?", answer: "The risk of transmission of COVID-19 through transfusion of blood and components is now only theoretical and likely minimal."),
    thing(question: "Can the coronaviruses be transmitted between animals and people?", answer: "Coronaviruses are zoonotic, meaning they are transmitted between animals and people. Detailed investigations found that SARS-CoV was transmitted from civet cats to humans and MERS-CoV from dromedary camels to humans. Several known coronaviruses are circulating in animals that have not yet infected humans.\n\nCommon signs of infection include respiratory symptoms, fever, cough, shortness of breath and breathing difficulties. In more severe cases, infection can cause pneumonia, severe acute respiratory syndrome, kidney failure and even death."),
    thing(question: "Can coronavirus disease spread through raw food?", answer: "As a general rule, the consumption of raw or undercooked animal products should be avoided. Raw meat, raw milk or raw animal organs should be handled with care to avoid cross- contamination with uncooked foods."),
    thing(question: "Can I breastfeed my child if I am severely ill with coronavirus disease?", answer: "If you are severely ill with COVID-19 or suffer from other complications that prevent you from caring for your infant or continuing direct breastfeeding, express milk to safely provide breastmilk to your infant.\n\nIf you are too unwell to breastfeed or express breastmilk, you should explore the possibility of relactation (restarting breastfeeding after a gap), wet nursing (another woman breastfeeding or caring for your child), or using donor human milk."),
    thing(question: "Can you contract the coronavirus disease by touching a surface?", answer: "People could catch COVID-19 by touching contaminated surfaces or objects – and then touching their eyes, nose or mouth"),
    thing(question: "Who is at risk for serious problems from Covid 19?", answer: "Most people (about 80%) recover from the disease without needing special treatment, and for the majority – especially for children and young adults – illness due to COVID-19 is generally minor.\n\nHowever, for some people it can cause serious illness. Around 1 in every 5 people who are infected with COVID-19 develop difficulty in breathing and require hospital care.\n\nPeople who are aged over 60 years, and people who have underlying medical conditions such as diabetes, heart disease, respiratory disease or hypertension are among those who are at greater risk of developing severe or critical illness if infected with the virus."),
    thing(question: "What is the usual body temperature in coronavirus disease patients?", answer: "The normal human body temperature remains around 36.5°C to 37°C, regardless of the external temperature or weather. The most effective way to protect yourself against the new coronavirus is by frequently cleaning your hands with alcohol-based hand rub or washing them with soap and water."),
    thing(question: "Is smoking a risk factor for COVID-19?", answer: "Smoking is already known to be a risk-factor for many other respiratory infections, including colds, influenza, pneumonia and tuberculosis. The effects of smoking on the respiratory system makes it more likely that smokers contract these diseases, which could be more severe.\n\nSmoking is also associated with increased development of acute respiratory distress syndrome, a key complication for severe cases of COVID-19, among people with severe respiratory infections."),
    thing(question: "What should we do midst the COVID 19 situation?", answer: " - Wear masks when outside\n - Ensure adequate or proper physical distancing\n - Maintain hygiene, don't touch face, wash hands, etc.\n - Appreciate the frontline workers for their contributions\n - Do not rush to stockpile large amounts and quantities of food\n - Scan SafeEntry QR Code to improve and enhance contact tracing")
]
...
let masksQuestions = [
    maskQuestion(question: "Breathability", options: ["Easy", "Hard"]),
    maskQuestion(question: "Comfort", options: ["Comfortable", "Uncomfortable"]),
    maskQuestion(question: "Fit", options: ["Loose", "Tight"]),
    maskQuestion(question: "Filtration (Blocking of Droplets or Particles)", options: ["None", "Some", "Most"]),
    maskQuestion(question: "Reusable", options: ["Yes", "No"]),
    maskQuestion(question: "Protection", options: ["Low", "Medium", "High"])
]
...
let masks = [
    mask(name: "Surgical Face Mask", description: " - Breathability: Easier to breathe\n - Filtration: Prevents the spread of the virus. May not protect the user from viruses. blocks large particles from reaching the mouth\n - Fit: Loose - airborne particles can still enter from the sides\n - Reusable: No\n - Protection: The three-layer surgical mask came second and had a more variable relative droplet count that ranged from zero to 0.1. At the third and fourth spot were the ones with polypropylene: the cotton-polypropylene-cotton mask and the 2-layer polypropylene apron mask.\n\nSurgical masks, with a more sophisticated design also meant to prevent the wearer from spreading diseases\n\nSurgical face masks are loose-fitting disposable masks that are readily available to the general public and can be purchased over-the-counter. They are often worn in operating rooms, dentists' offices, or during minor surgical procedures performed in doctors' offices. They are most effective at blocking infected liquids (usually bodily fluids). They do not block small particles such as airborne viruses. They also fail to provide complete protection because of the loose fit which allows air to leak around the sides of the mask.\n\nYou may encounter this type of mask in waiting rooms at doctors' offices, hospitals, or nursing homes. They are provided for use by individuals who are infected or suspect they may currently have some sort of infection. They are at least partially effective at blocking infected saliva or other large particles that may be emitted when a sick person coughs or sneezes. They can be uncomfortable to wear for any extended length of time.\n\nSurgical face masks must be removed and disposed of properly to avoid inadvertently infecting yourself with any germs that may be on the mask. Remove it using the ties that go behind the head (or ear loops) and wash your hands immediately after removal. Surgical masks should not be worn more than once.\n\nSurgical face masks are effective for:\n - Medical professionals participating in a procedure where the spread of body fluids may occur\n - Individuals who are sick to help to contain infected droplets emitted by coughing, sneezing, or talking\n\nSurgical face masks are not effective for the following uses:\n - Blocking small particles like airborne viruses or COVID-19\n - Preventing the risk of contracting a virus like the flu or COVID-19 in non-infected individuals\n\nA surgical face mask generally fits loosely over the nose and mouth and is a part of PPE (Personal Protective Equipment). These masks cover for the large cough or sneeze droplets, splashes, or sprays effectively. However, they are not ideal for the smaller droplets. Remember that you must never share these masks with anybody and must refrain from log term usage to avoid self-contamination.\n\nThis type of face mask is commonly used by doctors or nurses who operate in hospitals. Unlike the simple face mask which is widely used to avoid pollution, the function of the surgical mask is more to inhibit the spread of infection, not air filter. Some even say that surgical masks are actually not effective enough to ward off pollution. This mask is said to not be able to dispel chemicals, gases, or vapors.\n\nThe use of this mask must also be correct, must cover the entire area of the nose and chin, otherwise dust can still enter the nose and mouth. The use of this face mask is only one use and should not be too long.", imageName: ["Surgical Mask"]),
    mask(name: "N95 Respirator (Valved)", description: " - Breathability: Harder to breathe (small filtration system that blocks 95% of airborne particles)\n - Filtration: blocks particles from reaching the mouth and nose\n - Fit: Tight\n - Reusable: No\n - Protection: N95 masks with valves was ranked seventh, registering a relative droplet count ranging from 0.1 to 0.2. Fitted, non-valved N95 masks performed far superior to valved N95 masks because the exhalation valve opens for strong outward airflow and can decrease protection of persons surrounding the wearer\n\nN95 masks, which protect the wearer as well, and fit tightly to the face.\n\nN95 respirators are much more effective than surgical masks at filtering out small particles. In theory, they can eliminate up to 95% of small particles, including viruses. However, there are many factors that can limit their effectiveness.\n\nThese respirators are available to the general public and are often sold over-the-counter at home improvement stores. However, these masks are not necessarily intended for use in a healthcare setting, but rather to protect individuals from breathing in substances like sawdust while doing home repairs.\n\nN95 respirators must fit properly. They are designed to fit very close to the skin so that air leakage around the mask does not occur. When used in hospitals, employees must be professionally fit tested to determine the correct size respirator for their face. Facial hair—beards in particular—can prevent N95 respirators from sealing to the face and working correctly.\n\nLike surgical face masks, N95 respirators can protect against large particles and liquid splashes. However, they are designed for use when more protection than this is needed. They can be used in hospital settings to protect a caregiver from a patient who may have an infection that is airborne, such as tuberculosis. However, the respirator itself is only one part of several precautions taken to protect medical professionals from these pathogens. It is not intended to be used alone.\n\nN95 respirators are uncomfortable and hot to wear for any significant amount of time. Some N95 respirators have an exhalation valve which makes it easier to breathe while wearing the mask. Special surgical N95 respirators exist for medical personnel who are involved in surgical procedures that may involve high-velocity splashing and potential aerosolization of body fluids.\n\nLike all medical masks, N95 respirators must be put on correctly, worn correctly, and removed correctly in order to be effective. Medical personnel should be properly trained to avoid inadvertently infecting themselves while removing the respirator.\n\nN95 respirators are not particularly effective in the hands of the general public who have not been properly measured or trained to use these devices.\n\nOften used by healthcare professionals, N-95 masks are said to work best in preventing the transmission of respiratory droplets during regular speech. These masks consist of tangled fibres in order to filter the pathogens in the air, and they are also designed in a way that they fit very close to the face and the edges form a seal around the mouth and nose.\n\nHowever, it is suggested that you do not go for an N-95 mask unless you are a health worker or an essential service provider, since they are in critical supply. Not only that, recently the Ministry of Health has also warned all states and union territories against the use of N-95 masks with valved respirators. According to the Centre, these masks do not prevent the virus from spreading and prove to be “detrimental” to the measures adopted for its containment.\n\nSo with all the complications and contradiction, we say you should go for simpler and effective alternatives and leave the N-95 masks alone.\n\nN95 masks filter out at least 95% of very small particles when worn properly, including droplets carrying viruses. Versions with a plastic valve at the center, which makes the mask easier to exhale through, are intended for industrial workers and offer protection only to the wearer.\n\nTrue N95s aren’t easy to wear properly. They must have a tight seal to the face to ensure that all air goes through the filter instead of around the edges. But they offer the best protection against the coronavirus, which is why the WHO recommends these masks be reserved for health-care workers.", imageName: ["N95 (Valved)", "n95"]),
    mask(name: "N95 Respirator (No Valve)", description: " - Breathability: Harder to breathe (small filtration system that blocks 95% of airborne particles)\n - Filtration: blocks particles from reaching the mouth and nose\n - Fit: Tight\n - Reusable: No\n - Protection: N95 masks without exhalation valves, worn by frontline healthcare workers, were the best at blocking droplets and had a relative droplet count of zero.\n\nN95 respirators are much more effective than surgical masks at filtering out small particles. In theory, they can eliminate up to 95% of small particles, including viruses. However, there are many factors that can limit their effectiveness.\n\nThese respirators are available to the general public and are often sold over-the-counter at home improvement stores. However, these masks are not necessarily intended for use in a healthcare setting, but rather to protect individuals from breathing in substances like sawdust while doing home repairs.\n\nN95 respirators must fit properly. They are designed to fit very close to the skin so that air leakage around the mask does not occur. When used in hospitals, employees must be professionally fit tested to determine the correct size respirator for their face. Facial hair—beards in particular—can prevent N95 respirators from sealing to the face and working correctly.\n\nLike surgical face masks, N95 respirators can protect against large particles and liquid splashes. However, they are designed for use when more protection than this is needed. They can be used in hospital settings to protect a caregiver from a patient who may have an infection that is airborne, such as tuberculosis. However, the respirator itself is only one part of several precautions taken to protect medical professionals from these pathogens. It is not intended to be used alone.\n\nN95 respirators are uncomfortable and hot to wear for any significant amount of time. Some N95 respirators have an exhalation valve which makes it easier to breathe while wearing the mask. Special surgical N95 respirators exist for medical personnel who are involved in surgical procedures that may involve high-velocity splashing and potential aerosolization of body fluids.\n\nLike all medical masks, N95 respirators must be put on correctly, worn correctly, and removed correctly in order to be effective. Medical personnel should be properly trained to avoid inadvertently infecting themselves while removing the respirator.\n\nN95 respirators are not particularly effective in the hands of the general public who have not been properly measured or trained to use these devices.\n\nOften used by healthcare professionals, N-95 masks are said to work best in preventing the transmission of respiratory droplets during regular speech. These masks consist of tangled fibres in order to filter the pathogens in the air, and they are also designed in a way that they fit very close to the face and the edges form a seal around the mouth and nose.\n\nHowever, it is suggested that you do not go for an N-95 mask unless you are a health worker or an essential service provider, since they are in critical supply. Not only that, recently the Ministry of Health has also warned all states and union territories against the use of N-95 masks with valved respirators. According to the Centre, these masks do not prevent the virus from spreading and prove to be “detrimental” to the measures adopted for its containment.\n\nSo with all the complications and contradiction, we say you should go for simpler and effective alternatives and leave the N-95 masks alone.\n\nN95 masks filter out at least 95% of very small particles when worn properly, including droplets carrying viruses. Versions with a plastic valve at the center, which makes the mask easier to exhale through, are intended for industrial workers and offer protection only to the wearer.\n\nTrue N95s aren’t easy to wear properly. They must have a tight seal to the face to ensure that all air goes through the filter instead of around the edges. But they offer the best protection against the coronavirus, which is why the WHO recommends these masks be reserved for health-care workers.", imageName: ["N95 (No Valve)", "n95-no-valve"]),
    mask(name: "Simple/Fabric/Cloth Face Coverings/Mask", description: " - Breathability: Hard to breathe. Fabric becomes damp after using for a short period of time.\n - Filtration: blocks particles from reaching the mouth and nose.\n - Fit: Tight\n - Reusable: Yes\n - Protection: Four different two-layer cotton pleated masks and one one-layer cotton pleated mask occupied spots from fifth to eleventh, having relative droplet count range from zero to 0.4\n\nCloth masks or coverings like gaiters, intended to prevent an infected person from spreading the virus by catching large droplets\n\nThis cloth face mask is often worn by motorcyclists. Cloth face mask can only prevent large dust. So it is not effective to filter small size particles. Because it is made of fabric, this type of mask can be washed and can be used repeatedly. But,if this face mask is not properly washed, it will risk becoming a den of bacteria that can actually make the disease.\n\nThese masks can be made using a variety of fabrics and items of clothing, mostly a tightly woven cotton fabric is most suitable. Research shows that a combination of different fabrics like cotton, silk, chiffon, flannel, and various synthetics happens to be the most effective.", imageName: ["Fabric Mask", "Multi-Layer Mask", "fabricmasks"]),
    mask(name: "N95, N99, N100 Face Mask", description: "N95 face mask has recently been sought often after because claimed to be effective in preventing coronavirus infections. Quoted from the journal National Center for Biotechnology Information, U.S. The National Library of Medicine, surgical masks and N95 masks are suitable to prevent transmission of the virus, included Coronavirus.\n\nAs the name implies, the N95 mask is designed to prevent 95 percent of particles both large, small and fine (up to 0.3 microns), including those containing viruses in the air, as long as they are used properly.\n\nIf using the N95 mask properly, the nose and mouth will be tightly closed so that no air gaps enter. That is what makes this face mask considered uncomfortable because it is too tight so it makes breathing difficult. The use of this mask must be replaced immediately if the mask is damaged, wet, or dirty. Ideally, wear this mask for 8 hours and must be replaced, but it also has to be used once.\n\nBesides N95, there are also N99, N100 masks. Both types of masks have better effectiveness at filtering pollutants than N95 masks. As per the code, the N99 mask is able to filter pollutants up to 99%. The N100 mask is even better, can hold PM2.5 particles up to 99.97%. The weakness of the N95, 99, N100 masks is not resistant to pollutants that contain oil. Where the letter N of code N95 means not oil resistant or not oil resistant.", imageName: ["n-masks"]),
    mask(name: "R95, R99, R100 Face Masks", description: "R95, R99, and R100 face mask are able to withstand oil-type pollutants. This is in accordance with the code letter R (oil Resistant). This type of face mask usually used in environments that have pollutants containing oil aerosols such as in coal-burning, natural gas or petroleum smoke haze areas.\n\nThe code of this face mask shows the ability to ward off pollutants. R95 means can filter oil aerosol pollutants up to 95%, R99 can filter up to 99% and R100 can filter particles up to 99.97%. These three types of face masks can be used with an effective duration of up to 8 hours. Because this face mask is for certain conditions, it is more difficult to obtain than other types of masks.", imageName: ["r-masks"]),
    mask(name: "P95, P99, P100 Face Masks", description: "This type of face mask is also resistant to pollutants with oil content. Where the letter P in the code has the meaning Oil Proof. But besides that it is also effective in driving out small particles in the air. The use of P95, P99 and P100 masks can be longer, up to 40 hours.", imageName: ["p-masks"]),
    mask(name: "Electric Face Mask", description: "Electric face mask uses battery power and is equipped with fan filters to facilitate air circulation. That is why this mask is quite comfortable to use, because it does not cause sultry in the mouth area. The ability of this electric mask is also quite good in dispelling dust. This electric face mask has filter that must be replaced. In addition, the mask must also always be charged so that the fan can function.", imageName: ["masks1", "masks2", "masks3"]),
    mask(name: "Elastomeric Respirator", description: "Elastomeric respirators are not commonly used. They are very similar to N95 respirators in their capabilities to protect against viruses, but they are not disposable. This type of respirator is made of rubber or other synthetic materials and is meant to be disinfected with bleach after each use. This makes them less than ideal for use in hospitals.\n\nLike N95 respirators, elastomeric respirators have to be properly fitted to the face in order to be effective. This mask also has a filter that is thrown away and replaced. They can be purchased online and are often expensive", imageName: ["Elastrometric Respirator"]),
    mask(name: "Powered Air Purifying Respirators (PAPRs)", description: "Many healthcare settings are moving to the use of PAPRs due to their significant advantages over N95 masks. This type of respirator resembles a loose-fitting hood or a helmet. It is connected to a battery-powered motor that pushes air through a particle filter. The filtering capabilities are higher than that of an elastomeric respirator or an N95 and they are more comfortable to wear for longer periods of time.\n\nPAPRs must be properly cared for and maintained in order to function properly. The batteries must be fully-charged. Like other masks, they must be removed properly to avoid inadvertently infecting oneself. They also must be disinfected properly between uses. PAPRs are not a good option outside of the healthcare setting because they are expensive and require training for proper use.", imageName: ["PAPR masks"]),
    mask(name: "DIY/Homemade Mask", description: " - Breathability: Hard to breathe\n - Filtration: blocks no particles from reaching the mouth and nose.\n - Fit: Loose\n - Reusable: Yes\n - Protection: At number 13, the bandanna had a range of 0.2 to 1.1 while the fleece mask finished at number 14, with an average relative droplet count of 1.1. Simply put, this means a person wearing a fleece mask generated more droplets than when his or her nose and mouth had no covering at all. The researchers said this was likely because these types of masks break down large droplets into smaller particles, allowing them to slip out the sides of the covering more easily.", imageName: ["Home Made Mask", "Paper Mask"])
]

let virusmoresources = ["https://www.who.int/emergencies/diseases/novel-coronavirus-2019/advice-for-public"]
let virusNewsAndGov = ["MOH (Situation Report) [LIVE]", "covid19 SG [LIVE]", "Gov.sg Singapore COVID-19 Symptom Checker", "Gov.sg (Updates)", "Gov.sg (Cases)", "Gov.sg (Places)", "MOH (Updates)", "MOH (FAQs)", "MOH (Advisories)", "MOH (Situation Report) Detailed", "ICA (Border Measures)", "ICA (SHN)", "MFA", "HSA", "Google News", "Google Search", "WHO", "WHO (Q&A)", "CDC (Swab Test)", "SCMP", "MOH (Twitter)", "Gov.sg (Twitter)", "CNA", "ST (COVID-19 Pandemic)", "ST (COVID-19 Tag)", "Wikipedia", "MOH Mythbusters"]
let virusNewsAndGovSites = ["https://covidsitrep.moh.gov.sg/", "https://co.vid19.sg/singapore/", "https://sgcovidcheck.gov.sg/", "https://www.gov.sg/features/covid-19", "https://www.gov.sg/article/covid-19-cases-in-singapore", "https://www.gov.sg/article/covid-19-public-places-visited-by-cases-in-the-community-during-infectious-period", "https://www.moh.gov.sg/covid-19", "https://www.moh.gov.sg/covid-19/faqs", "https://www.moh.gov.sg/covid-19/advisories-for-various-sectors", "https://www.moh.gov.sg/covid-19/situation-report", "https://www.ica.gov.sg/covid-19", "https://www.ica.gov.sg/covid-19/shn", "https://www.mfa.gov.sg/Overseas-Mission/San-Francisco/Consular-Services/COVID-19", "https://www.hsa.gov.sg/announcements/news/moh-updates-on-covid19", "https://news.google.com/covid19/map?hl=en-SG&&gl=SG&ceid=SG%3Aen&mid=%2Fm%2F06t2t", "https://www.google.com/search?q=covid+19", "https://www.who.int/emergencies/diseases/novel-coronavirus-2019", "https://www.who.int/emergencies/diseases/novel-coronavirus-2019/question-and-answers-hub/q-a-detail/q-a-coronaviruses#", "https://www.cdc.gov/coronavirus/2019-ncov/downloads/community/COVID-19-testing-deep-nasal-self-swab.pdf", "https://www.scmp.com/coronavirus", "https://twitter.com/sporeMOH", "https://twitter.com/govsingapore", "https://www.channelnewsasia.com/news/topics/coronavirus-covid-19", "https://www.straitstimes.com/coronavirus", "https://www.straitstimes.com/tags/covid-19", "https://en.wikipedia.org/wiki/Coronavirus_disease_2019", "https://www.who.int/emergencies/diseases/novel-coronavirus-2019/advice-for-public/myth-busters"]
let virusVideos = ["https://www.youtube.com/watch?v=gff4GkGvW-Q", "https://www.youtube.com/embed/WLTV2groOxY", "https://www.youtube.com/embed/l3s75_X8Xjs", "https://www.youtube.com/embed/6cgI5bfHpQ4", "https://www.youtube.com/embed/421fmflQX0E", "https://www.youtube.com/embed/LfpbRQIa_Zo", "https://www.youtube.com/watch?v=I6UmEfovdOo", "https://www.youtube.com/embed/BvArUcf-1V4", "https://www.youtube.com/embed/nOa8wIhQdzo", "https://www.youtube.com/embed/mdX61H4Rsnw", "https://www.youtube.com/embed/1_AxGswGnno", "https://www.youtube.com/embed/yLSHNV4pSwc", "https://www.youtube.com/embed/eXhbQU9rzYo", "https://www.youtube.com/embed/l33a25lchT8", "https://www.youtube.com/embed/oRyuOLP5xUE", "https://www.youtube.com/embed/oDE8_4UTuRM", "https://www.youtube.com/embed/Qg8sRsERlwU", "https://www.youtube.com/embed/nOa8wIhQdzo", "https://www.youtube.com/embed/Qg8sRsERlwU"]
//VirusTable(
//    title: <#T##String#>,
//    data: [
//        VirusTableItem(
...
var VirusQuestions = [
    QuizQuestion(question: "How does COVID-19 spread?", choice1: "Through respiratory droplets exhaled when you cough or sneeze", choice2: "Through faeces from an infected person", choice3: "By drinking unclean water", choice4: "All of the above", correctChoice: .one),
    QuizQuestion(question: "What are NOT good foods to eat during the COVID-19 pandemic?", choice1: "Foods that are high in sugar, fat or salt", choice2: "Fresh and unprocessed foods that contain vitamins, minerals, dietary fibre, protein and antioxidants", choice3: "Nuts, wholegrains, oats", choice4: "Fruits, vegetables and legumes", correctChoice: .one),
    QuizQuestion(question: "Can COVID-19 mutate?", choice1: "Yes", choice2: "No", choice3: "Only Outside Singapore", choice4: "Only in America", correctChoice: .one),
    QuizQuestion(question: "What is COVID-19?", choice1: "A type of Virus", choice2: "A type of Bacteria", choice3: "A type of Fungus", choice4: "A type of Decomposer", correctChoice: .one),
    QuizQuestion(question: "How can COVID-19 be prevented?", choice1: "Wearing masks", choice2: "Washing hands without soap and water", choice3: "Going to crowded places", choice4: "Eating unhealthily", correctChoice: .one),
    QuizQuestion(question: "How should we treat frontline workers?", choice1: "Kindly", choice2: "Angrily", choice3: "Rudely", choice4: "Irritatingly", correctChoice: .one),
    QuizQuestion(question: "Can I wash my hands with ONLY running water?", choice1: "Yes", choice2: "No", choice3: "Up to youself", choice4: "And Drain Water", correctChoice: .two),
    QuizQuestion(question: "How is COVID 19 being tested?", choice1: "Faeces Test", choice2: "Nasal Swab Test", choice3: "Spit Test", choice4: "Urine Test", correctChoice: .two),
    QuizQuestion(question: "What is NOT the reason why we should wear masks during the COVID-19 situation?", choice1: "Most masks help to prevent us from getting the virus", choice2: "Masks are stylish", choice3: "Most masks prevent the spread of the virus", choice4: "All of the above", correctChoice: .two),
    QuizQuestion(question: "How long does COVID 19 last on surfaces?", choice1: "It doesn't last", choice2: "Up to 9 days", choice3: "1 month", choice4: "1 year", correctChoice: .two),
    QuizQuestion(question: "Are younger people immune to the virus?", choice1: "Yes", choice2: "No", choice3: "It depends on each person", choice4: "Everyone is immue to the virus", correctChoice: .two),
    QuizQuestion(question: "Where were COVID-19 cases mostly found in Singapore?", choice1: "Schools", choice2: "Dormitories", choice3: "Homes", choice4: "Offices", correctChoice: .two),
    QuizQuestion(question: "Is there a cure for/to COVID-19?", choice1: "Yes, a cure has been found long time ago", choice2: "Yes, a cure was found in August 2020", choice3: "No, it is currently in development", choice4: "Previous medicines can cure this virus", correctChoice: .three),
    QuizQuestion(question: "Should people get vaccinated once the vaccine comes out?", choice1: "Yes", choice2: "No", choice3: "Only elderly", choice4: "Our immune system is strong enough", correctChoice: .one),
    QuizQuestion(question: "Do you think that the Circuit Breaker period was useful in managing COVID 19?", choice1: "It wasted my time", choice2: "There were no changes in the cases observed", choice3: "The number of cases decreased", choice4: "The number of cases increased", correctChoice: .three),
    QuizQuestion(question: "Why is COVID-19 known as COVID-19?", choice1: "It was the name of its strain", choice2: "There have been 18 coronaviruses previously", choice3: "It was first discovered in November 2019", choice4: "It is a coronavirus", correctChoice: .three),
    QuizQuestion(question: "What was COVID 19 initally officially known as?", choice1: "SARS-COV-2", choice2: "COVID-19", choice3: "2019 n-CoV", choice4: "COVID-20", correctChoice: .three),
    QuizQuestion(question: "Which of the following are symptoms of COVID 19?", choice1: "Cough", choice2: "Runny nose", choice3: "High fever", choice4: "All of the above", correctChoice: .four),
    QuizQuestion(question: "Which of the following is a way to prevent the spread of COVID-19?", choice1: "Wiping down tables after eating", choice2: "Wear a mask", choice3: "Use hand sanitiser frequently", choice4: "All of the above", correctChoice: .four),
    QuizQuestion(question: "Can animals get COVID 19?", choice1: "Yes", choice2: "No", choice3: "Depends on each animal", choice4: "All of the above", correctChoice: .four),
    QuizQuestion(question: "Where did COVID 19 first appear?", choice1: "Singapore", choice2: "USA", choice3: "Wakanda", choice4: "Unknown, unable to comfirm", correctChoice: .four),
    QuizQuestion(question: "Why is it called Coronavirus?", choice1: "It is a cooler and more fashionable name", choice2: "It is spread through saliva which is a part of coronavirus family", choice3: "Because it is a virus", choice4: "Because it is covered by spikes that resemble crowns", correctChoice: .four),
    QuizQuestion(question: "How did COVID 19 first arrive in Singapore?", choice1: "It originated in Singapore", choice2: "From the Malaysia-Singapore Causeway", choice3: "Train to Busan", choice4: "Planes from Wuhan", correctChoice: .four)
]
