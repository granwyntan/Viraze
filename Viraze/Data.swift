...
let virusmore = [
    ...
    thing(question: "Is smoking a risk-factors for COVID-19?", answer: "Smoking is already known to be a risk-factor for many other respiratory infections, including colds, influenza, pneumonia and tuberculosis. The effects of smoking on the respiratory system makes it more likely that smokers contract these diseases, which could be more severe.\n\nSmoking is also associated with increased development of acute respiratory distress syndrome, a key complication for severe cases of COVID-19, among people with severe respiratory infections.")
]
...
var VirusQuestions = [
    ...
    QuizQuestion(question: "How long does COVID 19 last on surfaces?", choice1: "It doesn't last", choice2: "Up to 9 days", choice3: "1 month", choice4: "1 month", correctChoice: .two),
